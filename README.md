...
**GET /commerce/products/{categoryId}** //
...
**GET /commerce/product/{productId}** //
...
**GET /commerce/shopping/cart/find** //
...
**GET /commerce/shopping/checkout/{cartId} //cartId = 9**

![image](https://user-images.githubusercontent.com/102681681/201110162-24521ad6-af69-42d1-a896-a7122c593f63.png)

**DELETE /commerce/shopping/cart/{cartId}/remove/{productId} //cartId = 11, productId = 5**
